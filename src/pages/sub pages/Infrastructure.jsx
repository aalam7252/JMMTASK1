...
import v11 from '../../assets/MP4/v11.mp4'
    ...
    <div className=' h-[200vh]'>
      {/* div main container 1 */}
        <div className='bg-teal-200 h-[50vh] flex flex-col justify-center  pl-14 pt-14 bg-gradient-to-br from-[#5F39FF] to-[#20D9A1] text-white '>
            <div className='text-[70px] text-[700] font-bebas'>Infrastructure Services</div>
            <div className='text-[18px] text-[500] font-mukta'>Home &gt;  Services &gt;  Infrastructure Services </div>
        </div>
        ...
        <div className='h-[70vh]   flex justify-between'>
          <div className=' p-14 w-[100%] '>
            <video className='  object-cover h-[100%] w-[100%] rounded-[50px]' autoPlay loop muted>
              <source src={v11} typeof='video/mp4'/>
            </video>
          </div>
        ...
        <div className='px-14  relative h-[80vh]'>
          <div>
            <div>
              <div className='text-[#3A3A3A] text-[54px] font-bebas'>Infrastructure        <span className='text-transparent bg-clip-text bg-gradient-to-r from-[#00CC85] via-[#009985] to-[#0060B7]'>Services </span></div>
              <div className='font-mukta'>Our infrastructure services ensure your IT systems are robust, reliable, and scalable. From network design to server management, <br /> we provide comprehensive solutions to support your business operations. <br /> <br />

Our expertise ensures your infrastructure can handle your current needs and future growth..</div>
            </div>
            ...
            <div className='mt-10 flex gap-5'>
              <div className='relative bg-[#00CC851A] h-[30vh] w-[33%] mt-[2%] rounded-3xl'>
                ...
                <div className='top-20 absolute ml-[10%] font-mukta text-[22px] text-[#3A3A3A] font-bold'>Network Design</div>
                <div className='text-[#727272] absolute top-32 ml-[10%]  font-mukta text-[16px] '>Designing and implementing robust network <br /> solutions for seamless connectivity.</div>
              </div>
              ...
              <div className='relative bg-[#00CC851A] h-[30vh] w-[33%] mt-[2%] rounded-3xl'>
                ...
                <div className='top-20 absolute ml-[10%] font-mukta text-[22px] text-[#3A3A3A] font-bold'>Server Management</div>
                <div className='text-[#727272] absolute top-32 ml-[10%]  font-mukta text-[16px] text-[400] '>Managing server infrastructure to ensure reliability <br /> and performance.</div>
              </div>
