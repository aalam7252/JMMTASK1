...
import v14 from '../../assets/MP4/v14.mp4'
    ...
    <div className=' h-[200vh]'>
      {/* div main container 1 */}
        <div className='bg-teal-200 h-[50vh] flex flex-col justify-center  pl-14 pt-14 bg-gradient-to-br from-[#5F39FF] to-[#20D9A1] text-white '>
            <div className='text-[70px] text-[700] font-bebas'>Integration Services</div>
            <div className='text-[18px] text-[500] font-mukta'>Home &gt;  Services &gt;  Integration Services</div>
        </div>
        ...
        <div className='h-[70vh]   flex justify-between'>
          <div className=' p-14 w-[100%] '>
            <video className='  object-cover h-[100%] w-[100%] rounded-[50px]' autoPlay loop muted>
              <source src={v14} typeof='video/mp4'/>
            </video>
          </div>
        ...
        <div className='px-14  relative h-[80vh]'>
          <div>
            <div>
              <div className='text-[#3A3A3A] text-[54px] font-bebas'>Integration           <span className='text-transparent bg-clip-text bg-gradient-to-r from-[#00CC85] via-[#009985] to-[#0060B7]'>Services</span></div>
              <div className='font-mukta'>Our integration services streamline your business processes by connecting disparate systems and applications. This ensures <br />seamless data flow and operational efficiency. <br /> <br />

We specialize in system integration and API development, providing customized solutions to meet your unique needs.</div>
            </div>
            ...
            <div className='mt-10 flex gap-5'>
              <div className='relative bg-[#00CC851A] h-[30vh] w-[33%] mt-[2%] rounded-3xl'>
                ...
                <div className='top-20 absolute ml-[10%] font-mukta text-[22px] text-[#3A3A3A] font-bold'>System Integration</div>
                <div className='text-[#727272] absolute top-32 ml-[10%]  font-mukta text-[16px] '>Connecting various systems and applications for <br /> seamless data flow.</div>
              </div>
              ...
              <div className='relative bg-[#00CC851A] h-[30vh] w-[33%] mt-[2%] rounded-3xl'>
                ...
                <div className='top-20 absolute ml-[10%] font-mukta text-[22px] text-[#3A3A3A] font-bold'>API Development</div>
                <div className='text-[#727272] absolute top-32 ml-[10%]  font-mukta text-[16px] text-[400] '>Developing APIs to facilitate integration with third- <br />party applications.</div>
              </div>
