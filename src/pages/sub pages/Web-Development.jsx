...
import v8 from '../../assets/MP4/v8.mp4'
    ...
    <div className=' h-[200vh]'>
      {/* div main container 1 */}
        <div className='bg-teal-200 h-[50vh] flex flex-col justify-center  pl-14 pt-14 bg-gradient-to-br from-[#5F39FF] to-[#20D9A1] text-white '>
            <div className='text-[70px] text-[700] font-bebas'>Web Development</div>
            <div className='text-[18px] text-[500] font-mukta'>Home &gt;  Services &gt;  Web Development</div>
        </div>
        ...
        <div className='h-[70vh]   flex justify-between'>
          <div className=' p-14 w-[100%] '>
            <video className='  object-cover h-[100%] w-[100%] rounded-[50px]' autoPlay loop muted>
              <source src={v8} typeof='video/mp4'/>
            </video>
          </div>
        ...
        <div className='px-14  relative h-[80vh]'>
          <div>
            <div>
              <div className='text-[#3A3A3A] text-[54px] font-bebas'>Design &      <span className='text-transparent bg-clip-text bg-gradient-to-r from-[#00CC85] via-[#009985] to-[#0060B7]'>Development</span></div>
              <div className='font-mukta'>Our web development services are designed to enhance your online presence with custom website solutions. <br />
                                We combine creativity with technical expertise to build websites that are visually appealing, highly functional, and <br />
                                user-friendly. <br /> <br />
                                
                                We understand the importance of a responsive and mobile-friendly design in today’s digital world. Our web <br />
                                development process includes thorough testing and optimization to ensure your site performs seamlessly across <br />
                                all devices.</div>
            </div>
            ...
            <div className='mt-10 flex gap-5'>
              <div className='relative bg-[#00CC851A] h-[30vh] w-[33%] mt-[2%] rounded-3xl'>
                ...
                <div className='top-20 absolute ml-[10%] font-mukta text-[22px] text-[#3A3A3A] font-bold'>Custom Web Design</div>
                <div className='text-[#727272] absolute top-32 ml-[10%]  font-mukta text-[16px] '>Tailored website designs that reflect your brand’s <br /> identity and engage users effectively.</div>
              </div>
              ...
              <div className='relative bg-[#00CC851A] h-[30vh] w-[33%] mt-[2%] rounded-3xl'>
                ...
                <div className='top-20 absolute ml-[10%] font-mukta text-[22px] text-[#3A3A3A] font-bold'>Responsive Development</div>
                <div className='text-[#727272] absolute top-32 ml-[10%]  font-mukta text-[16px] text-[400] '>Building websites that offer a seamless experience across all devices and screen sizes.</div>
              </div>
